...
public class VirtualNetworkConfig implements Comparable<VirtualNetworkConfig> {
    ...
    public String toString() {
        return "VirtualNetworkConfig(" + nwid + ", " + mac + ", " + name + ", " + status + ", " + type + ", " + mtu + ", " + dhcp + ", " + bridge + ", " + broadcastEnabled + ", " + portError + ", " + enabled + ", " + netconfRevision + ", " + Arrays.toString(assignedAddresses) + ", " + Arrays.toString(routes) + ", " + dns + ")";
    }
    ...
    public int hashCode() {
        ...
        result = 37 * result + (dhcp ? 0 : 1);
        result = 37 * result + (bridge ? 0 : 1);
        result = 37 * result + (broadcastEnabled ? 0 : 1);
