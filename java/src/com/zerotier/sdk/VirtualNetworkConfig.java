...
public class VirtualNetworkConfig implements Comparable<VirtualNetworkConfig> {
    ...
    public String toString() {
        return "VirtualNetworkConfig(" + nwid + ", " + mac + ", " + name + ", " + status + ", " + type + ", " + mtu + ", " + dhcp + ", " + bridge + ", " + broadcastEnabled + ", " + portError + ", " + netconfRevision + ", " + Arrays.toString(assignedAddresses) + ", " + Arrays.toString(routes) + ", " + dns + ")";
    }
